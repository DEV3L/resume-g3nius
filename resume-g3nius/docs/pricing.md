...
<div style="text-align: center; background-image: url('images/pricing/pricing-hero.png'); background-size: cover; background-position: center; padding: 60px 0; position: relative; top: -16px;">
  ...
  <h2 style="font-size: 3.25rem; font-weight: 700; margin: 0; position: relative; text-shadow: 2px 2px 12px rgba(0, 0, 0, 0.8);">
    Empower Your Career
  </h2>
</div>
...
- **Market Insights Report**: Professionally crafted headlines, summaries, and keyword integration.
...
Looking to level up your career tools even further? Customize your plan with these powerful add-ons:
...
<img src="../images/character-profiles/dnd-0.png" class="slide-show" 
     style="display: block; margin: auto; width: 100%; max-width: 800px; margin-bottom: 20px; aspect-ratio: 16 / 9;">
<img src="../images/character-profiles/pokemon-0.png" class="slide-show" 
     style="display: block; margin: auto; width: 100%; max-width: 800px; margin-bottom: 20px; aspect-ratio: 16 / 9;">
<img src="../images/character-profiles/dnd-1.png" class="slide-show" 
     style="display: block; margin: auto; width: 100%; max-width: 800px; margin-bottom: 20px; aspect-ratio: 16 / 9;">
<img src="../images/character-profiles/pokemon-1.png" class="slide-show" 
     style="display: block; margin: auto; width: 100%; max-width: 800px; margin-bottom: 20px; aspect-ratio: 16 / 9;">
<img src="../images/character-profiles/dnd-2.png" class="slide-show" 
     style="display: block; margin: auto; width: 100%; max-width: 800px; margin-bottom: 20px; aspect-ratio: 16 / 9;">
<img src="../images/character-profiles/pokemon-2.png" class="slide-show" 
     style="display: block; margin: auto; width: 100%; max-width: 800px; margin-bottom: 20px; aspect-ratio: 16 / 9;">
...
[Start a Conversation](contact.md) to customize your plan with these add-ons.
...
[Start a Conversation](contact.md) for custom pricing.
